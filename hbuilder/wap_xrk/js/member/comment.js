...
mui.plusReady(function() {
    ...
    //	var $key = "45aadd684ed95f41977d56018a02ff0d";
    ...
    $(".send-comment").on("tap", function() {
        ...
        $.ajax({
            ...
            data: {
                ...
                comment: $val,
                anony: $anony,
                evaluate_image: imgArr,
                store_desccredit: $des,
                store_servicecredit: $atu,
                store_deliverycredit: $spd
            },
            success: function(res) {
                ...
                if (data.code != 200) {
                    ...
                    mui.alert(data.datas);
//                  mui.openWindow({
//                  	url: "service-order-all.html",
//                      id: "service-order-all",
//                      extras: {
//                      	order: true
//                      }
//                  });
