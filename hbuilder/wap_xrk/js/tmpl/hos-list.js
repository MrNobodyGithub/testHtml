$(function() {
		...
		$.ajax({
			...
			success: function(res) {
				...
				if(result != '') {
					...
					html = '<img src="../images/hos/banner11-11.png" alt="">';
				}
	...
	$(".hospital-list .yuyue").on("tap", function() {
		// 护工需要传二级分类  医院护工
		$classInfo.gcId = '7';
		var url = 'member/publish_needs_step2.html';
		console.log("医院护工"+JSON.stringify($classInfo));
		mui.openWindow({
			url: url,
			id: _.pageName.publish_needs_step2,
			createNew: false,
			extras: {
				classInfo: $classInfo
			},
