		...
		success: function(data) {
			...
			$('.detail-info .bottom').on('tap', 'a', function() {
				if($is_person == 0) {
					...
					window.location.href = WapSiteUrl + '/tmpl/store-detail.html?storeId='+$store_info.store_id;
//					mui.openWindow({
...
//					})
					...
					window.location.href = WapSiteUrl + '/tmpl/personal-detail.html?goods_id='+goodsId;
//					mui.openWindow({
...
//				mui.fire(common_books_Page, 'loaddata', booksparam);
			...
			$('.mui-pull-right').off('tap').on('tap', function(e) {
				window.location.href = WapSiteUrl+'/tmpl/comment-detail-list.html?$goodsId='+$goodsId
//				mui.openWindow({
...
//				})
			...
			$('.footer-menu .kf').off('tap').on("tap", function() {
				window.location.href = WapSiteUrl+'/tmpl/message/chat.html';
//				mui.openWindow({
//					url: 'chat.html',
//					id: 'message_chat',
//					waiting: {
